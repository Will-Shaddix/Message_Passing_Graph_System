...
class ActiveList : public ClockedObject
{
    ...
    private:
        ...
        uint64_t requestor_1 = 99999990;
        uint64_t requestor_2 = 99999990;

        uint64_t writer_1 = 99999990;
        uint64_t writer_2 = 99999990;
