...
class GraphInit(ClockedObject):
    ...
    partition_size = Param.UInt64("Size of the partition.")
    edge_partitioned = Param.Int("is Edge partitioned?")
    vertex_partitioned = Param.Int("is Vertex partitioned?")
    num_partitions = Param.UInt64("Number of partitions.")
    mem_ctrl_size = Param.UInt64("Size of the memory controller.")
